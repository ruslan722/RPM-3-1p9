...
class StudentForm(StatesGroup):
    ...
    enter_subject = State()      
    enter_grade = State()   
    select_grade = State()         # Состояние выбора оценки
    change_grade_value = State()   # Состояние изменения значения оценки
    grade_action_cycle = State()   # Состояние для действий после выбора 
